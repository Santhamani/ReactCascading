...
// db.connect(function(err) {
  ...
  db.query("CREATE DATABASE IF NOT EXISTS obscst_blueappletechno	", function(err,results){
    if(err) throw err;
...
// db.connect(function(err){
// if(err) throw err;
db.query("USE obscst_blueappletechno",(err,results) => {
  if(err) throw err;
